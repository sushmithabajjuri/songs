...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { director: @music.director, duration: @music.duration, movie: @music.movie, name: @music.name, singer: @music.singer }
    end
  ...
  test "should update music" do
    patch :update, id: @music, music: { director: @music.director, duration: @music.duration, movie: @music.movie, name: @music.name, singer: @music.singer }
    assert_redirected_to music_path(assigns(:music))
  end
